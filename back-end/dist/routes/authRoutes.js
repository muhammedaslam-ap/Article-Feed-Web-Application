...
class authRoutes {
    ...
    initializeRoutes() {
        this.router.post('/register/user', (0, validateDTO_1.validateDTO)(userValidation_1.registerSchema), (req, res) => authInjection_1.injectedAuthController.registerUser(req, res));
        this.router.post("/login", (req, res) => authInjection_1.injectedAuthController.loginUser(req, res));
        this.router.post("/logout", (req, res) => authInjection_1.injectedAuthController.logoutUser(req, res));
        this.router.post("/refresh-token", (req, res) => userInjection_1.injectedRefreshTokenController.handle(req, res));
